...
// FORK: product-wide default setting overrides. These change the built-in defaults so a fresh
// profile starts with the fork's preferred editor/workbench settings. Registered at module load
// (unconditionally, independent of the style-override CSS group above). Users can still override
// any of these in their own user/workspace settings.
Registry.as<IConfigurationRegistry>(ConfigurationExtensions.Configuration).registerDefaultConfigurations([{
	overrides: {
		...
		'php.validate.executablePath': '/Users/houtarou/.config/herd-lite/bin/php',
	}
}]);
