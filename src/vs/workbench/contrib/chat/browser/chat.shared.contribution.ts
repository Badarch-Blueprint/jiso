...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		[ChatConfiguration.AgentStatusEnabled]: {
			...
			default: 'hidden', // FORK: keep the normal command center search box; don't replace it with the Copilot agent widget
			tags: ['experimental']
		},
		...
		[ChatConfiguration.ChatViewSessionsEnabled]: {
			type: 'boolean',
			// FORK: hide the in-chat "SESSIONS" history panel by default (use the tab strip / Recent
			// Chats instead). Still toggleable via this setting.
			default: false,
		...
		[ChatConfiguration.TitleBarSignInEnabled]: {
			...
			default: false, // FORK: hide Copilot Sign In button in title bar by default
		},
		...
		'chat.allowAnonymousAccess': { // TODO@bpasero remove me eventually
			...
			default: true, // FORK: allow chat without GitHub Copilot sign-in by default (no setup-required / sign-in gating while signed out)
			included: false,
			tags: ['experimental'],
		},
...
// FORK: removed the Copilot status-bar entry (ChatStatusBarEntry) — no Copilot in this fork.
