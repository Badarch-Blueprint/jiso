	...
	constructor() {
		super({
			...
			keybinding: {
				...
				// FORK: Cmd/Ctrl+L opens chat (Cursor-style). Previous Cmd+Alt+I / Ctrl+Cmd+I kept as secondary.
...
export function registerChatActions() {
	...
	MenuRegistry.appendMenuItem(MenuId.ViewTitle, {
		...
		group: 'navigation',
		// FORK: keep the chat header minimal (only the New Chat "+") — never show the gear.
