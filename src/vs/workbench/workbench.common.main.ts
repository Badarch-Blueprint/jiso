...
// Workspace Switcher
import './contrib/workspaceSwitcher/browser/workspaceSwitcher.contribution.js';

// Claude sign-in (native provider auth)
import './contrib/chat/browser/agentSessions/agentHost/claudeAuthService.js';
