...
export interface CreateSessionParams extends BaseParams {
	...
	/**
	 * FORK: additional directories the session may access beyond
	 * `workingDirectory` (multi-root workspaces). Serialized as strings on the
	 * wire, like `workingDirectory`.
	 */
	additionalDirectories?: URI[];
	/**
