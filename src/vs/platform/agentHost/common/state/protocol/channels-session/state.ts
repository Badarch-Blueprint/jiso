...
export interface SessionMetadata {
	...
	/**
	 * FORK: extra directories this session may access beyond `workingDirectory`
	 * (multi-root workspaces — e.g. a backend + frontend repo). Stored as strings
	 * (like `workingDirectory` on the wire) so the agent host's permission manager
	 * can treat edits in any workspace folder as in-scope.
	 */
