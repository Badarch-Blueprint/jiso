 ...
 *   the user's own credentials — the CLI's own `claude` login (Keychain /
 *   `~/.claude`), or anything the user exports in their shell; the IDE holds
 *   and injects no credential and no proxy is involved. The SDK's bundled `claude` CLI runs the
 *   turn.
 */
