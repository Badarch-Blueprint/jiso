...
import type { CompletionsParams, CompletionsResult, CreateTerminalParams, IClaudeContextUsage, IClaudePlanUsage, ResolveSessionConfigResult, SessionConfigCompletionsResult } from '../common/state/protocol/commands.js';
...
import { runClaudeUtilityPrompt } from './claude/claudeUtilityPrompt.js';
...
export class AgentService extends Disposable implements IAgentService {
	...
	constructor(
		...
		this._sideEffects = this._register(instantiationService.createInstance(AgentSideEffects, this._stateManager, {
			...
			// Generate session titles with the local Claude CLI (no GitHub Copilot dependency).
			runUtilityPrompt: (messages, token) => runClaudeUtilityPrompt(messages, token, this._logService),
